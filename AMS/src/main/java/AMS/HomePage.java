...
public class HomePage extends JFrame implements ActionListener
{
    ...
    HomePage()
    {
        ...
        f1=new Font("MS UI Gothi",Font.BOLD,18);
        
ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("icons/23.png"));
Image img = ic.getImage().getScaledInstance(1200,800, Image.SCALE_SMOOTH);
ImageIcon scaledIcon = new ImageIcon(img);
l1 = new JLabel(scaledIcon);
l1.setBounds(0, 0, 1200,800);
        ...
        JMenuItem ment11=new JMenuItem("Check Payment Details");
        men6.add(ment11);
        m1.add(men6);
     ...
     public void actionPerformed(ActionEvent e)
    {
        ...
        else if(cmd.equals("Check Payment Details"))
        {
